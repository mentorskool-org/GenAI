...
if uploaded_files:
    ...
    if "processed_data" not in st.session_state:
        ...
        #     vectorstore = Chroma.from_documents(document_chunks, embeddings)
        # except Exception:
        #     st.error("Please enter the valid OpenAI API Key!", icon="🚨")
        #     st.stop()
...
## The given chatbot only gives the answer related to the document, what along with document we want the
## answers from web also.